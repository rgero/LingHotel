    ...
    <StyledSalesChart>
      ...
      <ResponsiveContainer width="100%" height={300}>
        <AreaChart data={data}>
          ...
          <Area dataKey="totalSales" type="monotone" stroke={colors.totalSales.stroke} fill={colors.totalSales.fill} name="Total Sales"/>
          <Area dataKey="extrasSales" type="monotone" stroke={colors.extrasSales.stroke} fill={colors.extrasSales.fill} name="Extras Amount"/>
        </AreaChart>
      </ResponsiveContainer>
    </StyledSalesChart>
  )
